...
public class UsageDataRecordingSettings implements UploadSettings {
	...
	static final String UPLOAD_URL_DEFAULT = "http://localhost:3000/api/upload_data"; //$NON-NLS-1$ //TODO: update this to the real address
...
//TODO remove this once transition completed
	...
	/* (non-Javadoc)
	 * @see ca.ubc.cs.commandrecommender.usagedata.recording.settings.UploadSettings#hasUserAcceptedTermsOfUse()
	 */
	...
	private UsageDataCaptureSettings getCaptureSettings() {
		return ca.ubc.cs.commandrecommender.usagedata.gathering.UsageDataCaptureActivator.getDefault().getSettings();
	}

	/* (non-Javadoc)
	 * @see ca.ubc.cs.commandrecommender.usagedata.recording.settings.UploadSettings#isEnabled()
	 */
