...
public class RecommendationRetrievalService {
	//TODO: Add preference string for this
	private static final String RECOMMENDER_SERVER = "http://localhost:3000/create_recommendations";
	...
	private String getUrlFromServer(){
		...
		HttpPost httpPost = new HttpPost(RECOMMENDER_SERVER);
	...
	public void getRecommendation() {
		...
		retrieveRecommendaitonFromServer();
	}
	private void sendUsageDataToServer() {
		UsageDataRecordingActivator.getDefault().getUploadManager().startUpload();
	}
	protected void retrieveRecommendaitonFromServer() {
